"""
Django settings for truqui_center project.
...
THEME = {
    ...
    "banner": os.environ.get("THEME_BANNER", "#555555"),
    "banner_fg": os.environ.get("THEME_BANNER_FG", "#ffffff"),
...
INSTALLED_APPS = [
    ...
    "src.infrastructure.database.teams",
]
...
ROOT_URLCONF = "truqui_center.urls"
...
WSGI_APPLICATION = "truqui_center.wsgi.application"
...
STATICFILES_DIRS = [
    BASE_DIR / "src" / "interface" / "web" / "static",
]
